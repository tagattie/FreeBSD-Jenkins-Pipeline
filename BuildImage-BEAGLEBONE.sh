...
(cd ${WORKDIR}/${FBPARTFSLABEL}/boot/dtb && \
    ${SUDO_COMMAND} ln -f beaglebone.dtb am335x-bone.dtb &&
    ${SUDO_COMMAND} ln -f beaglebone-black.dtb am335x-boneblack.dtb)
...
echo "sudo dd if=${IMAGEDIR}/${IMAGEFILE} of=/dev/<your SD card> bs=1m"
